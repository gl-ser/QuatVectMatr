...
#### _TVector трёхмерный вектор, имеющий координаты x, y, z_
```
Методы TVector:
...
#### _TMatrix матрица 3x3, состоящая из трёх объектов типа TVector_
```
...
#### _TQuaternion кватернион, имеющий атрибуты q0, q1, q2, q3_
```
